...
{	
	...
	public <T> T getEntityFromPut(String url,HttpEntity<?> requestEntity,Class<T> responseType, Map<String, ?> uriVariables) {
		return getEntity(url, HttpMethod.PUT, requestEntity, responseType, uriVariables);
	}
	
	public <T> T getEntityFromPut(String url,HttpEntity<?> requestEntity,Class<T> responseType) {
		return getEntity(url, HttpMethod.PUT, requestEntity, responseType);
	}
	
	public <T> T getEntityFromDelete(String url,HttpEntity<?> requestEntity,Class<T> responseType, Map<String, ?> uriVariables) {
		return getEntity(url, HttpMethod.DELETE, requestEntity, responseType, uriVariables);
	}
	
	public <T> T getEntityFromDelete(String url,HttpEntity<?> requestEntity,Class<T> responseType) {
		return getEntity(url, HttpMethod.DELETE, requestEntity, responseType);
	}
